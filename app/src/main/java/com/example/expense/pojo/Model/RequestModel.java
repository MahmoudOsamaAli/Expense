package com.example.expense.pojo.Model;
...
public class RequestModel  implements Parcelable {
    ...
    public RequestModel(String id, String name, String category, String phoneNumber, String description, String facebookUrl, String twitterUrl,String instagramUrl, String websiteUrl, int likesCount, int okayCount, int dislikesCount, ArrayList<LocationModel> locationModels, ArrayList<String> imagesURL,String date) {
        this.id = id;
        this.name = name;
    ...
    public RequestModel(String name, String category, String phoneNumber, String description, String facebookUrl, String twitterUrl,String instagramUrl ,String websiteUrl, ArrayList<LocationModel> locationModels, int likesCount, int okayCount, int dislikesCount, ArrayList<String> imagesURL,String date) {
        this.name = name;
        this.category = category;
        this.phoneNumber = phoneNumber;
        this.description = description;
